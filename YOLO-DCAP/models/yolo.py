...
from models.common import (
	...
	Proto,
    ## module added here
	ConvMDRB, C3Att, C3CBAM, ViTBlock
	)
...
#### also we need to add those module in here
        if m in {
                Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, MixConv2d, Focus, CrossConv,
                BottleneckCSP, C3, C3TR, C3SPP, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, MDRB, SSCA, C3Att, ViTBlock, C3CBAM}:
            c1, c2 = ch[f], args[0]
